...
export async function submitPartnerApplication(body) {
    const id = uuid();
    await pool.query(`INSERT INTO partner_applications (
    ...
    await emailService.sendPartnerApplicationReceived(String(body.contactEmail), String(body.companyName));
