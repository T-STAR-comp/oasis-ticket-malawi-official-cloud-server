...
export const BRAND_RGB: [number, number, number] = [63, 169, 245];
...
let patternCache: Promise<PatternTiles> | null = null;

async function loadPatternTiles(): Promise<PatternTiles> {
...
export async function getPatternTiles(): Promise<PatternTiles> {
  if (!patternCache) patternCache = loadPatternTiles();
  return patternCache;
}
...
export function drawPatternPageBackground(
  doc: PdfDoc,
  pageW: number,
  pageH: number,
  tiles: PatternTiles,
...
export function drawPatternHeader(
  doc: PdfDoc,
  pageW: number,
  margin: number,
  tiles: PatternTiles,
...
export function drawContentCard(
  doc: PdfDoc,
  x: number,
  y: number,
  width: number,
...
export function drawPatternAccentBand(
  doc: PdfDoc,
  x: number,
  y: number,
  width: number,
...
export function drawOperatorPanel(
  doc: PdfDoc,
  x: number,
  y: number,
  width: number,
